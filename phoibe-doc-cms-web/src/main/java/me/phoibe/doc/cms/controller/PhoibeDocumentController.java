...
public class PhoibeDocumentController {
	...
	public String saveDoucument(@PathVariable Integer start, @PathVariable Integer limit, PhoibeDocument param) {
		...
		// PageList<PhoibeDocument> pageList =
		// phoibeDocumentService.fetchDocumentByPageList(pageParam);

		List<PhoibeDocument> list = phoibeDocumentMapper.selectByPage(null);
